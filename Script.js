// About Popup functions (for both index.html and room1.html)
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Attach event listeners only if elements exist on the current page
    if (aboutBtn) {
    ...
    // Initialize the timer if the necessary elements are present (i.e., on room1.html)
